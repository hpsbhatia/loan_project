    ...
    @if(count($details))
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-2">
                <a href="{{ route('staff-depositor-edit',$details->id) }}" class="btn btn-primary btn-block"><i class="fa fa-edit"></i> Edit Details</a>
            </div>
            <div class="col-md-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-depositor-confirm') }}" class="form-inline">
                        {!! csrf_field() !!}
