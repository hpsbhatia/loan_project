        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    {!! Form::model($testimonial,['route'=>['testimonial-update',$testimonial->id],'method'=>'put','class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="name" value="{{ $testimonial->name }}" class="form-control input-lg" type="text" required placeholder="Author Name">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="description" id="" cols="30" rows="5"
                                          class="form-control input-lg" placeholder="Testimonial Description" required>{{ $testimonial->description }}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" class="btn blue btn-block margin-top-10"><i class="fa fa-send"></i> Update Testimonial</button>
                                </div>
                            </div>
                        </div>
                    </div>
