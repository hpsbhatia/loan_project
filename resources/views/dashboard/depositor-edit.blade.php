                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($details,['route'=>['depositor-update',$details->id],'method'=>'put','files'=>true]) !!}
                                ...
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" name="depositor_image" id="" class="form-control input-lg">
                                    </div>
                                ...
                                <input type="hidden" name="depositor_id" value="{{ $details->id }}">
