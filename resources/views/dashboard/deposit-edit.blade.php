        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    {!! Form::model($loan,['route'=>['deposit-update',$loan->id],'method'=>'put','class'=>'form-horizontal']) !!}
                    <div class="form-body">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">Deposit Package Name : </label>

                            <div class="col-sm-6">
                                <input name="name" value="{{ $loan->name }}" class="form-control input-lg" type="text" required placeholder="Deposit Package Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="amount" value="{{ $loan->amount }}" class="form-control input-lg" type="number" required placeholder="Deposit Package Price">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label">Deposit Interest : </label>

                            <div class="col-sm-6">
                                <input name="percentage" value="{{ $loan->percentage }}" class="form-control input-lg" type="number" required placeholder="Deposit Interest">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" class="btn blue btn-block margin-top-10"> <i class="fa fa-send"></i> Update Deposit Package</button>
                                </div>
                            </div>
                        </div>
                    </div>
