    ...
    @if(count($details))
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="well">
                        ...
                        <p><span>Loaner Rating : </span> <i><b>{{ $details->rating }}</b></i></p>
                        <p><span>Salary : </span> <i><b>{{ $details->salary }}</b></i></p>
                        <p><span>Other Income : </span> <i><b>{{ $details->other_income }}</b></i></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="well">
                        <img style="width: 180px;height: 160px" src="{{ asset('images') }}/{{ $details->loaner_image }}" alt="">
                        <p><span>Date Of Birth : </span> <i><b>{{ date('d-F-Y',strtotime($details->birth_date)) }}</b></i></p>
                        <p><span>Spouse Salary : </span> <i><b>{{ $details->salary_spouse }}</b></i></p>
                        <p><span>Spouse Other Income : </span> <i><b>{{ $details->other_income_spouse }}</b></i></p>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-2">
                <a href="{{ route('lend-edit',$details->id) }}" class="btn btn-primary btn-block"><i class="fa fa-edit"></i> Edit Details</a>
            </div>
            <div class="col-md-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('loner-confirm') }}" class="form-inline">
                        {!! csrf_field() !!}
