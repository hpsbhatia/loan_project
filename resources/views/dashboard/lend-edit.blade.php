                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($details,['route'=>['loaner-update',$details->id],'method'=>'put','files'=>true]) !!}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="package_id" id="" class="form-control input-lg" required>
                                            ...
                                            @foreach($package as $s)
                                                @if($s->id == $details->package_id)
                                                    <option value="{{ $s->id }}" selected>{{ $s->name }} - {{ $s->amount }} {{ $s->currency->name }} - {{ $s->rate }} {{ $s->currency->name }} - {{ $s->installment }} Installment</option>
                                                @else
                                ...
                                <div class="row" style="margin-top: 15px">
                                    <div class="col-md-12">
                                        <label>Select Staff Under Loan:</label>
                                        <select name="staff_id" id="" class="form-control input-lg" required>
                                            <option value="">Select One</option>
                                            @foreach($staff as $s)
                                                @if($s->id == $details->staff_id)
                                                    <option value="{{ $s->id }}" selected>{{ $s->name }} - {{ $s->username }} </option>
                                                @else
                                ...
                                <div class="row" style="margin-top:15px">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="first_name" value="{{ $details->first_name }}" class="form-control input-lg" type="text"
                                               required="" placeholder="First Name">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Last Name:</label>
                                        <input name="last_name" value="{{ $details->last_name }}" class="form-control input-lg" type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="spouse_name" value="{{ $details->spouse_name }}" class="form-control input-lg" type="text"
                                               placeholder="Spouse Name">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Date Of Birth :</label>
                                        <input type="text" value="{{ $details->birth_date }}" class="form-control input-lg" name="birth_date" id="date1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="email" value="{{ $details->email_name }}" name="email_name" class="form-control input-lg"
                                               type="email"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="phone_number" value="{{ $details->phone_number }}" name="phone_number" class="form-control input-lg" type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="father_name" value="{{ $details->father_name }}" class="form-control input-lg" type="text"
                                               required="" placeholder="Father Name">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Mother Name:</label>
                                        <input name="mother_name" value="{{ $details->mother_name }}" class="form-control input-lg" type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="present_address" id="" cols="30" rows="5"
                                                  ...
                                                  placeholder="Present Address">{{ $details->present_address }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="permanent_address" id="" cols="30" rows="5"
                                                  class="input-lg form-control" required
                                                  placeholder="Permanent Address">{{ $details->permanent_address }}</textarea>
                                    </div>
                                ...
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="col-md-6">
                                        <label>Name:</label>
                                        <input name="emergency_name" value="{{ $details->emergency_name }}" class="form-control input-lg" type="text"
                                               required="" placeholder="Name">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Relationship:</label>
                                        <input name="emergency_relationship" value="{{ $details->emergency_relationship }}" class="form-control input-lg" type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="emergency_phone" class="form-control input-lg" type="text"
                                               required="" value="{{ $details->emergency_phone }}" placeholder="Emergency Phone">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="emergency_address" id="" cols="30" rows="1"
                                                  class="input-lg form-control" required
                                                  placeholder="Emergency Address">{{ $details->emergency_address }}</textarea>
                                    </div>
                                ...
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" name="loaner_image" id="" class="form-control input-lg">
                                    </div>
                                ...
                                <input type="hidden" name="loner_id" value="{{ $details->id }}">
