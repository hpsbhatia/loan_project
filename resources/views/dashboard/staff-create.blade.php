                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="email" value="" class="form-control input-lg" type="email" required placeholder="Staff Email">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="username" value="" class="form-control input-lg" type="text" required placeholder="Staff User Name">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="phone" value="" class="form-control input-lg" type="text" required placeholder="Staff Phone">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" class="btn blue btn-block margin-top-10"><i class="fa fa-paper-plane"></i> Create New Staff</button>
                                </div>
                            </div>
                        </div>
                    </div>
