                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        ...
                        <span class="username"> Welcome, {!! Auth::guard('staff')->user()->name !!} </span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">

                        <li><a href="{!! route('staff-change-pass') !!}"><i class="fa fa-cogs"></i> Change Password </a>
                        </li>
                        <li><a href="{!! route('staff-logout') !!}"><i class="fa fa-sign-out"></i> Log Out </a></li>
    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item">
                    <a href="{!! route('staff-loan-installment') !!}" class="nav-link nav-toggle"><i class="fa fa-list-alt"></i>
                        <span class="title">Loan Installment</span></a>
                </li>

                <li class="nav-item">
                    <a href="{!! route('staff-deposit-installment') !!}" class="nav-link nav-toggle"><i class="fa fa-list-alt"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('staff-lend-create') !!}" class="nav-link"><i class="fa fa-plus"></i> New Loan</a>
                        </li><li class="nav-item">
                            <a href="{!! route('staff-lend-calc') !!}" class="nav-link"><i class="fa fa-desktop"></i> Calculate Loan</a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('staff-lend-show') !!}" class="nav-link"><i class="fa fa-desktop"></i> All Loan</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('staff-depositor-create') !!}" class="nav-link"><i class="fa fa-plus"></i> New Depositor</a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('staff-depositor-show') !!}" class="nav-link"><i class="fa fa-desktop"></i> All Depositor</a>
                        </li>
                    </ul>
                </li>
