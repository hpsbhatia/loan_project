                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <?php $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($p->loner->package->rate); ?> - <?php echo e($p->loner->package->currency->name); ?></td>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="label control-label label-danger"><i class="fa fa-plus"></i> <?php echo e($p->loner->package->fine); ?> <?php echo e($p->loner->package->currency->name); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
