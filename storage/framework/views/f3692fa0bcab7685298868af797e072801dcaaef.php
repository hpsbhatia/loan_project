                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        ...
                        <span class="username"> Welcome, <?php echo Auth::guard('staff')->user()->name; ?> </span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">

                        <li><a href="<?php echo route('staff-change-pass'); ?>"><i class="fa fa-cogs"></i> Change Password </a>
                        </li>
                        <li><a href="<?php echo route('staff-logout'); ?>"><i class="fa fa-sign-out"></i> Log Out </a></li>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item start">
                    <a href="<?php echo route('staff-dashboard'); ?>" class="nav-link ">
                ...
                <li class="nav-item">
                    <a href="<?php echo route('staff-loan-installment'); ?>" class="nav-link nav-toggle"><i class="fa fa-list-alt"></i>
                        <span class="title">Loan Installment</span></a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo route('staff-deposit-installment'); ?>" class="nav-link nav-toggle"><i class="fa fa-list-alt"></i>
                        <span class="title">Deposit Installment</span></a>
                </li>

                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle"><i class="fa fa-cloud-upload"></i>
                        <span class="title">Manage Loan</span><span class="arrow"></span></a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="<?php echo route('staff-lend-create'); ?>" class="nav-link"><i class="fa fa-plus"></i> New Loan</a>
                        </li><li class="nav-item">
                            <a href="<?php echo route('staff-lend-calc'); ?>" class="nav-link"><i class="fa fa-desktop"></i> Calculate Loan</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo route('staff-lend-show'); ?>" class="nav-link"><i class="fa fa-desktop"></i> All Loan</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="<?php echo route('staff-depositor-create'); ?>" class="nav-link"><i class="fa fa-plus"></i> New Depositor</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo route('staff-depositor-show'); ?>" class="nav-link"><i class="fa fa-desktop"></i> All Depositor</a>
                        </li>
                    </ul>
                </li>
