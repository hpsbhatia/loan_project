...
<!-- BEGIN LOGO -->
<div class="logo">
    <a href="#"><img src="<?php echo e(asset('images/logo.png')); ?>" alt="-" style="filter: brightness(0) invert(1);"/> </a>
</div>
<!-- END LOGO -->

<div class="content">
    <?php echo Form::open(['route'=>'staff-post-login','class'=>'login-form']); ?>
    ...
    <div class="form-group">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="E-mail" name="username" /> </div>
    <div class="form-group">
